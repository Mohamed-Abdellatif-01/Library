...
<div><h1 style="font-size: 4vw; text-align: center; color: #fff" class="m-3">All Books</h1></div>
...
<a href="<?php echo base_url();?>library/mainpage"/><br><input type="button" value="Back To Main Page >>" class="btn btn-success"/></a>
