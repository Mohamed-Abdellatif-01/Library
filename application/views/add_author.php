...
<body>
	...
	<div><h1  style="font-size: 3vw; text-align: center; color: #fff" class="m-3">Add Author</h1></div>
	<?php
	if(isset($result))
	{
		echo '<p  style="font-size: 2vw;" class="m-3">Author added successfully</p>';
	echo	'<a href="'.base_url().'library/add_author" /><br><input type="button" value="+ Add Author " class="btn btn-primary	  mt-2" /></a>';
